...
#[Route('/quizqeee', name: 'quizqeee_')]
#[IsGranted('ROLE_MANAGER')]
class QuizQeeeController extends AbstractController
{
    const admn = ''; const admn_ = ''; const xxxxxx = self::admn_.'quizqeee';
    const uupper = self::admn_.'qaaa'; const vupper = self::admn_.'qaaa'; 
    const ulower = self::admn_.'qddd'; const vlower = self::admn_.'qddd';
    const llll = [ 'title' => 'Quiz Qeee',
