...
use App\Entity\Visit as DcmntEntity;
use App\Entity\Visit as UlowerEntity;
use App\Entity\Visit as VlowerEntity;
//use App\Form\VisitType as DcmntType;
use App\Repository\VisitRepository as DcmntRepository;
//use App\Repository\VisitRepository as UpperURepository;
//use App\Repository\VisitRepository as UpperVRepository;
//use App\Security\VisitVoter as DcmntVoter;
...
#[Route('/{_locale}/visit', name: 'visit_locale_', requirements: ['_locale' => "%app_locales%"])]
#[IsGranted('ROLE_MANAGER')]
class VisitController extends AbstractController
{
    const admn = ''; const admn_ = ''; const xxxxxx = self::admn_.'visit';
    const uupper = self::admn_.'visit'; const vupper = self::admn_.'visit'; 
    const ulower = self::admn_.'visit'; const vlower = self::admn_.'visit';
    const llll = [ 'title' => 'Visit',
