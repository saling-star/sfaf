...
use App\Entity\Qccc as DcmntEntity;
use App\Entity\Qddd as UlowerEntity;
use App\Entity\Qccc as VlowerEntity;
use App\Form\QcccType as DcmntType;
use App\Repository\QcccRepository as DcmntRepository;
//use App\Repository\QbbbRepository as UpperURepository;
//use App\Repository\QbbbRepository as UpperVRepository;
//use App\Security\QcccVoter as DcmntVoter;
...
#[Route('/admin/qccc', name: 'admin_qccc_')]
#[IsGranted('ROLE_MANAGER')]
class QcccController extends AbstractController
{
    const admn = 'admin/'; const admn_ = 'admin_'; const xxxxxx = self::admn_.'qccc';
    const uupper = self::admn_.'qbbb'; const vupper = self::admn_.'qbbb'; 
    const ulower = self::admn_.'qddd'; const vlower = self::admn_.'qddd';
    const llll = [ 'title' => 'Qccc',
