...
use App\Entity\Qddd as DcmntEntity;
use App\Entity\Qddd as UlowerEntity;
use App\Entity\Qddd as VlowerEntity;
use App\Form\QdddType as DcmntType;
use App\Repository\QdddRepository as DcmntRepository;
//use App\Repository\QcccRepository as UpperURepository;
//use App\Repository\QeeeRepository as UpperVRepository;
//use App\Security\QdddVoter as DcmntVoter;
...
#[Route('/admin/qddd', name: 'admin_qddd_')]
#[IsGranted('ROLE_MANAGER')]
class QdddController extends AbstractController
{
    const admn = 'admin/'; const admn_ = 'admin_'; const xxxxxx = self::admn_.'qddd';
    const uupper = self::admn_.'qccc'; const vupper = self::admn_.'qeee'; 
    const ulower = self::admn_.'qddd'; const vlower = self::admn_.'qddd';
    const llll = [ 'title' => 'Qddd',
