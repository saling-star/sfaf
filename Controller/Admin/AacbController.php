...
#[Route('/admin/aacb', name: 'admin_aacb_')]
#[IsGranted('ROLE_ADMIN')]
class AacbController extends AbstractController
{
    const admn = 'admin/'; const admn_ = 'admin_'; 
    const xxxxxx = self::admn_.'aacb'; //const uppert = self::admn_.'aacb';
    const uupper = self::admn_.'aacb'; const vupper = self::admn_.'aacb';
    const tlower = self::admn_.'aacb'; const ulower = self::admn_.'abbb'; const vlower = self::admn_.'abbb';
    const llll = [ 'title' => 'Aacb',
