...
#[Route('/admin/qaaa', name: 'admin_qaaa_')]
#[IsGranted('ROLE_MANAGER')]
class QaaaController extends AbstractController
{
    const admn = 'admin/'; const admn_ = 'admin_'; const xxxxxx = self::admn_.'qaaa';
    const uupper = self::admn_.'qbbb'; const vupper = self::admn_.'qbbb'; 
    const ulower = self::admn_.'qeee'; const vlower = self::admn_.'qeee';
    const llll = [ 'title' => 'Qaaa',
