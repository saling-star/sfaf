...
use App\Entity\Qbbb as DcmntEntity;
use App\Entity\Qccc as UlowerEntity;
use App\Entity\Qaaa as VlowerEntity;
use App\Form\QbbbType as DcmntType;
use App\Repository\QbbbRepository as DcmntRepository;
...
#[Route('/admin/qbbb', name: 'admin_qbbb_')]
#[IsGranted('ROLE_MANAGER')]
class QbbbController extends AbstractController
{
    const admn = 'admin/'; const admn_ = 'admin_'; const xxxxxx = self::admn_.'qbbb';
    const uupper = self::admn_.'qbbb'; const vupper = self::admn_.'qbbb'; 
    const ulower = self::admn_.'qccc'; const vlower = self::admn_.'qaaa';
    const llll = [ 'title' => 'Qbbb',
