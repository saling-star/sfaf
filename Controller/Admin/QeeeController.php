...
//use App\Repository\QaaaRepository as UpperURepository;
//use App\Repository\QaaaRepository as UpperVRepository;
...
#[Route('/admin/qeee', name: 'admin_qeee_')]
#[IsGranted('ROLE_MANAGER')]
class QeeeController extends AbstractController
{
    const admn = 'admin/'; const admn_ = 'admin_'; const xxxxxx = self::admn_.'qeee';
    const uupper = self::admn_.'qaaa'; const vupper = self::admn_.'qaaa'; 
    const ulower = self::admn_.'qddd'; const vlower = self::admn_.'qddd';
    const llll = [ 'title' => 'Qeee',
