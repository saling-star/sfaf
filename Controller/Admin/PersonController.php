...
use App\Entity\Person as DcmntEntity;
use App\Entity\Person as UlowerEntity;
use App\Entity\Person as VlowerEntity;
use App\Form\PersonType as DcmntType;
use App\Repository\PersonRepository as DcmntRepository;
//use App\Repository\PersonRepository as UpperURepository;
//use App\Repository\PersonRepository as UpperVRepository;
//use App\Security\PersonVoter as DcmntVoter;
...
{
    const admn = 'admin/'; const admn_ = 'admin_'; const xxxxxx = self::admn_.'person';
    const uupper = self::admn_.'person'; const vupper = self::admn_.'person'; 
    const ulower = self::admn_.'person'; const vlower = self::admn_.'person';
    const llll = [ 'title' => 'Person',
