...
use App\Entity\Cultur as DcmntEntity;
use App\Entity\Cultur as UlowerEntity;
use App\Entity\Cultur as VlowerEntity;
use App\Form\CulturType as DcmntType;
use App\Repository\CulturRepository as DcmntRepository;
//use App\Repository\CulturRepository as UpperURepository;
//use App\Repository\CulturRepository as UpperVRepository;
//use App\Security\CulturVoter as DcmntVoter;
...
#[Route('/admin/cultur', name: 'admin_cultur_')]
#[IsGranted('ROLE_MANAGER')]
class CulturController extends AbstractController
{
    const admn = 'admin/'; const admn_ = 'admin_'; const xxxxxx = self::admn_.'cultur';
    const uupper = self::admn_.'cultur'; const vupper = self::admn_.'cultur'; 
    const ulower = self::admn_.'cultur'; const vlower = self::admn_.'cultur';
    const llll = [ 'title' => 'Cultur',
